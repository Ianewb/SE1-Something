...
public class Chat {
	...
	public Chat() {
		...
		JPanel chat_lbl = new JPanel();
		JLabel chat_word = new JLabel("Chat");
		chat_lbl.setPreferredSize(new Dimension(300, 40));
		chat_lbl.add(chat_word, SwingConstants.CENTER);
		...
		chat.add(chat_lbl, BorderLayout.NORTH);
